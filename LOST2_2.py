...
#Revision History:
#  - Edit of Story; grammar, spelling
#  - Comments

import time

#Method that prompts the User to make a decision
def choosePath():
    path = ""
...
#The start of the game, and the first decision
def node0():
    ...
    #User is prompted, and if/else calls the appropriate node.
...
#If User chose the forest they find a house
def node1():
    ...
    #Node is called based on User decision 
    chosenPath = choosePath()
    if(chosenPath == 1):
        node3()
    else:
...
#If User chose the ridge path they find a River
def node2():
    print("Stumbling down the ridge path ...")
    time.sleep(2)
    print("You manage to catch yourself before tumbling into a dark, wide river.")
    time.sleep(2)
    print("A few metres downriver you think you see a ford.")
    print
    #next decision
    time.sleep(4)
    print("Do you attempt to cross the river (1), ")
    time.sleep(2)
    print("Or follow the river? (2)")
    time.sleep(2)

    #Nodes are called based on User's choice
    chosenPath = choosePath()
    if(chosenPath == 1):
        node5()
    else:
...
#If User bypasses the House they find the driveway
def node3():
    ...
    #Outcomes are decided by the User Choice.
    chosenPath = choosePath()
    if(chosenPath == 1):
        outcomes(1)
    else:
...
#If the User knocks on the door they talk to the lady of the house
def node4():
    ...
    time.sleep(2)
    print("Slowly, footsteps are heard heading towards to door.")
    time.sleep(2)
...
#Crossing the river the User can go through the water or over.
def node5():
...
#If User walks along the river they encounter a Cougar
def node6():
...
#All the possible outcomes are output based on if/elif/else list.
def outcomes(whichOutcome):
    #USER SURVIVES! They find a police car on the road
    if(whichOutcome == 1):
        ...
        time.sleep(2)
    #USER DIES! They are caught in a bear trap and bleed out
    elif(whichOutcome == 2):
    ...
    #USER DIES! The Lady and Husband butcher you for food.    
    elif(whichOutcome == 3):
    ...
    #USER DIES! The Son hunts you through the woods, they are shot in the head.    
    elif(whichOutcome == 4):
        ...
        time.sleep(2)
        print("You put pressure on the wound, but your death is inevitable.")
        time.sleep(2)
        ...
        print
        time.sleep(4)
        print("but are cut short when the kind old lady promptly begins to admonish her ")
    ...
    #USER DIES! User slips and hits their head on the rocks, and drown    
    elif(whichOutcome == 5):
    ...
    #USER DIES! The River is freezing and User gets Hypothermia
    elif(whichOutcome == 6):
    ...
    #USER DIES! They trip into the River, fall down a Waterfall, and drown
    elif(whichOutcome == 7):
    ...
    #USER DIES! The cougar runs the User down before they can get to a tree.
    else:
        print("The trees!")
        time.sleep(2)
        ...
        time.sleep(2)
        print("Incrementally you slow, trying to get your bearings")
        time.sleep(2)
        print("Too slow.")
        time.sleep(2)
        print
        print("The cougar lands on your back, its teeth at your neck")
        time.sleep(2)
